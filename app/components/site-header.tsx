...
export function SiteHeader() {
  ...
  return (
    <header
      className={`header-enter fixed top-0 left-0 right-0 z-50 border-b backdrop-blur-md transition-[background-color,border-color,box-shadow,min-height] duration-500 ease-out ${
        scrolled
    ...
    >
      <div
        className={`mx-auto flex max-w-[1400px] items-center justify-between px-6 py-2 transition-[min-height] duration-500 ease-out md:px-10 ${
          scrolled
            ? "min-h-16 md:min-h-[4.25rem]"
            : "min-h-[5.75rem] sm:min-h-[6.75rem] md:min-h-32 lg:min-h-[9rem]"
        }`}
      >
